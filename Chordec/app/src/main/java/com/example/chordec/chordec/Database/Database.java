...
public class Database extends SQLiteOpenHelper{
    ...
    private static final String CHORD_TIME = "chord_time";
    ...
    private static final int    CHORD_TIME_INDEX = 3;
    private static final int    CHORD_FILE_PATH_INDEX = 4;
    ...
    public void insertChord(Chord chord) {
        ...
        values.put(CHORD_TIME, chord.getChordTime());
